...
class _CareerState extends State<Career> {
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      CommonText("Yr", 10, AppColor.whiteColor,
                          TextAlign.start),
                    ],
                  ),
                  const SizedBox(
              ...
              children: [
                Container(
                    ...
                    decoration: BoxDecoration(
                        color: (careerModel.body![index].passing!
                            .passingAttempts
                            .toString() ==
                            "0")
                            ? AppColor.backColor
                            : (careerModel.body![index].passing!
                            .passingAttemptsC
                            .toString() ==
                            "green")
                            ? AppColor.greenColor : (careerModel.body![index]
                            .passing!
                            .passingAttemptsC
                            .toString() ==
                            "red")
            ...
            Row(
              children: [
                Container(
                    ...
                    margin: const EdgeInsets.only(top: 2),
                    decoration: BoxDecoration(
                        color: (careerModel.body![index].rushing!
                            .rushingAttempts
                            .toString() ==
                            "0")
                            ? AppColor.backColor
                            : (careerModel.body![index].rushing!
                            .colourRushingAttempts
                            .toString() ==
                            "green")
                            ? AppColor.greenColor : (careerModel.body![index]
                            .rushing!
                ...
                Container(
                    ...
                    child: BoldText(
                        (careerModel.body![index].rushing!
                            ...
                            ? ""
                            : careerModel
                            .body![index].rushing!.rushingYards
                            .toString(),
                        10,
                        AppColor.black,
                        TextAlign.center)
            ...
            Row(
              children: [
                Container(
                    ...
                    margin: const EdgeInsets.only(top: 2),
                    decoration: BoxDecoration(
                        color: (careerModel.body![index].receiving!
                            .receivingTargets
                            .toString() ==
                            "0")
                            ? AppColor.backColor
                ...
                Container(
                    ...
                    child: BoldText(
                        (careerModel.body![index].receiving!
                            ...
                            ? ""
                            : careerModel
                            .body![index].receiving!.receptions
                            .toString(),
                        10,
                        AppColor.black,
                        TextAlign.center)),
  ...
  Future<void> getData() async {
    ...
    var data = await vm.getTableListWeek(
        context, widget.playerId, widget.teamId, widget.position);
