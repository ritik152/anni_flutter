...
class _TableListState extends State<TableList> {
  ...
  Widget build(BuildContext context) {
    return (vm.isLoading == true) ? const SizedBox() : (vm.seasonList.body ==
                  ...
                  SizedBox(
                    ...
                    child: (vm.isLoading2 == true) ? SizedBox(
                        width: MediaQuery
                            ...
                            .size
                            .width)
                        : (vm.tableModel.body == null ||
                        vm.tableModel.body!.isEmpty)
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    const SizedBox(height: 3,),
                                    CommonText("Opp", 10, AppColor.whiteColor,
                                        TextAlign.start),
                                  ],
                                ),
                                const SizedBox(
                                ...
                                (widget.position == "QB")
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        CommonText(
                                            "ATT", 10, AppColor.whiteColor,
                                            TextAlign.start),
                                        const SizedBox(
                                          width: 33,
                                        ),
                                        CommonText(
                                            "CMP", 10, AppColor.whiteColor,
                                            TextAlign.start),
                                        const SizedBox(
                                          width: 33,
                                        ),
                                        CommonText(
                                            "YD", 10, AppColor.whiteColor,
                                            TextAlign.start),
                                        const SizedBox(
                                          width: 37,
                                        ),
                                        CommonText(
                                            "TD", 10, AppColor.whiteColor,
                                            TextAlign.start),
                                        const SizedBox(
                                          width: 41,
                                        ),
                                        CommonText(
                                            "INT", 10, AppColor.whiteColor,
                                            TextAlign.start),
                                        const SizedBox(
                                          width: 24,
                                        ),
                                    ...
                                    Row(
                                      children: [
                                        CommonText(
                                            "TAR", 10, AppColor.whiteColor,
                                            TextAlign.start),
                                        const SizedBox(
                                          width: 30,
                                        ),
                                        CommonText(
                                            "REC", 10, AppColor.whiteColor,
                                            TextAlign.start),
                                        const SizedBox(
                                          width: 35,
                                        ),
    ...
    return (vm.tableModel.body!.length < index + 1) ? const SizedBox() : Row(
      ...
      children: [
        ...
        SizedBox(
            width: 33,
            child: BoldText(
                (vm.tableModel.body![index].jsonData!.opponent.toString() ==
                    "null") ? "" : vm.tableModel.body![index].jsonData!.opponent
                    .toString(), 11, AppColor.whiteColor, TextAlign.start)),
              ...
              children: [
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.passingAttempts
                            .toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.passingAttempts
                            .toString(),
                        10,
                ...
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.passingCompletions
                            .toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.passingCompletions
                            .toString(),
                        10,
                ...
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.passingYards
                            .toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.passingYards
                            .toString(),
                        10,
                ...
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.passingTouchdowns
                            .toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.passingTouchdowns
                            .toString(),
                        10,
                ...
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!
                            .passingInterceptions.toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!
                            .passingInterceptions.toString(),
                        10,
                        AppColor.whiteColor,
                        TextAlign.center)),
              ...
              children: [
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.rushingAttempts
                            .toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.rushingAttempts
                            .toString(),
                        10,
                ...
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.rushingYards
                            .toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.rushingYards
                            .toString(),
                        10,
                ...
                Container(
                    ...
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!
                            .rushingYardsPerAttempt.toString() == "null")
                            ? "0"
                            :
                        vm.tableModel.body![index].jsonData!
                            .rushingYardsPerAttempt.toString(),
                        10,
                        AppColor.black,
                        TextAlign.center)),
                const SizedBox(width: 3,),
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.rushingTouchdowns
                            .toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.rushingTouchdowns
                            .toString(),
                        10,
              ...
              children: [
                ...
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.receivingTargets
                            .toString() == "null") ? "0" : vm.tableModel
                            .body![index].jsonData!.receivingTargets.toString(),
                        10,
                        AppColor.black,
                        TextAlign.center)),
                const SizedBox(width: 3,),
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.receptions
                            .toString() == "null") ? "0" : vm.tableModel
                            .body![index].jsonData!.receptions.toString(), 10,
                        AppColor.black,
                        TextAlign.center)),
                const SizedBox(width: 3,),
                Container(
                    ...
                    const EdgeInsets.symmetric(
                        ...
                        vertical: 3),
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!.receivingYards
                            .toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.receivingYards
                            .toString(), 10,
                        AppColor.black,
                ...
                Container(
                    ...
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!
                            .receivingYardsPerReception.toString() == "null")
                            ? "0"
                            :
                        vm.tableModel.body![index].jsonData!
                            .receivingYardsPerReception.toString(), 10,
                        AppColor.black,
                        TextAlign.center)),
                const SizedBox(width: 3,),
                Container(
                    ...
                    child: BoldText(
                        (vm.tableModel.body![index].jsonData!
                            .receivingTouchdowns.toString() == "null") ? "0" :
                        vm.tableModel.body![index].jsonData!.receivingTouchdowns
                            .toString(),
                        10,
                        AppColor.black,
                        TextAlign.center)),
  ...
  Future<void> getSeason() async {
    ...
    if (spf.getString(AllKeys.selectedYear).toString() != "null" ||
        spf.getString(AllKeys.selectedYear).toString() == "") {
