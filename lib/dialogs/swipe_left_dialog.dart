...
class SwipeLeftDialog extends StatefulWidget {

  const SwipeLeftDialog({Key? key}) : super(key: key);

  @override
  State<SwipeLeftDialog> createState() => _SwipeLeftDialog();

}

class _SwipeLeftDialog extends State<SwipeLeftDialog> {
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: [
              ...
              BoldText("Left", 16, AppColor.textGreenColor, TextAlign.center),
            ],
          ),
          const SizedBox(height: 5,),
          MediumText("Swipe the screen to the\nleft to view player stats", 13, AppColor.whiteColor, TextAlign.center),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
                onPressed: () {
                  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=> const SwipeRight()), (route) => false);
